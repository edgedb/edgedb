...
def test_algos_boolean_minimize():
    ...
    assert boolean.minimize(ones) == {(1, 0, None, None), (None, 0, 1, None), (0, None, None, 0)}
    ...
    assert boolean.minimize(ones, dcs) in [{(None, None, 0, 1), (0, 0, 1, None), (None, 1, None, 1)},
                                           {(0, None, None, 1), (0, 0, 1, None), (None, 1, None, 1)}]

    ones = boolean.ints_to_terms(4, 5, 6, 8, 9, 10, 13)
    dcs = boolean.ints_to_terms(0, 7, 15)

    assert boolean.minimize(ones, dcs) == {(0, None, 0, 1), (None, None, 1, 0), (1, 0, None, 1)}

    ones = boolean.ints_to_terms(0, 1, 2, 3, 4, 6, 7, 8, 9, 11, 15)
    assert boolean.minimize(ones) == {(0, None, None, 0), (None, 0, 0, None), (1, 1, None, None)}
