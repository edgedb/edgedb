...
"""A collection of functions and classes to simplify output formatting
for terminal"""
...
from edgedb.lang.common.colorsys import rgb_distance as color_distance
from edgedb.lang.common.colorsys import Color
...
def supports_colors(fileno):
    """Checks if ``fileno`` file-descriptor supports colored output

    :params int fileno: file-descriptor
    :returns: bool
    """

    return isatty(fileno) and os.getenv('TERM') != 'dumb' \
...
def use_colors(fileno=None):
    """Central framework function to check on whether use colored output
    or not.  Checks ``shell.MainCommand.colorize`` config setting and
...
#
_MAP256 = {16: '#000000',  17: '#00005f',  18: '#000087',  19: '#0000af',  20: '#0000d7',
          ...
          241: '#606060', 242: '#666666', 243: '#767676', 244: '#808080', 245: '#8a8a8a',
          246: '#949494', 247: '#9e9e9e', 248: '#a8a8a8', 249: '#b2b2b2', 250: '#bcbcbc',
          251: '#c6c6c6', 252: '#d0d0d0', 253: '#dadada', 254: '#e4e4e4', 255: '#eeeeee'}


class AbstractStyle:
    """Encapsulates information about text-style.  For instance, what color should text
    be, should it be underlined or bold etc.

    Use instances of :class:`Style16` or :class:`Style256`, this class is abstract.
    """
    ...
    def __init__(self, *, color=None, bgcolor=None,
                 ...
                 underline=False, overline=False, reverse=False):
    ...
    underline   = property(_is_opt_getter('underline'), _set_opt_setter('underline'))
...
class Style256(AbstractStyle):
    ...
    _rgb_color_table = {Color.from_string(v).rgb_channels(as_floats=True) : k \
