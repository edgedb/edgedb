...
from . import base
from . import dml
from .singleton import SingletonExprIRCompiler  # NOQA


class IRCompiler(base.IRCompilerBase,
    ...
    def transform_to_sql_tree(self, ir_expr, *, schema, backend=None,
        ...
        try:
            ...
            try:
                ...
                args = []
            err = base.IRCompilerInternalError(*args)
            err_ctx = base.IRCompilerErrorContext(tree=ir_expr)
