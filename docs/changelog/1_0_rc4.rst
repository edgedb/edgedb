...
* :eql:stmt:`for <FOR>` loops no longer require wrapping everything
...
* Release `edgedb-python <https://github.com/edgedb/edgedb-python>`_
  v0.20.1 driver. This version will now automatically retry on
  ``TransactionConflictError``.
* Release `edgedb-js <https://github.com/edgedb/edgedb-js>`_ v0.18.0 driver.
* Release `edgedb-go <https://github.com/edgedb/edgedb-go>`_ v0.10.0 driver.
