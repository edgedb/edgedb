...
``gen_salt`` and ``crypt`` functions for your hashing, ecrypting and salting
needs.
...
This extension provides a bunch of functionality used to determine string
similarity, which makes it a good text search alternative for some use cases:
