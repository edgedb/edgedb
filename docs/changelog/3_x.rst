...
If you're still running pre-1.0 EdgeDB instances like 1.0-beta3, and would like
to upgrade to 3.0, you would need a dump-restore towards version 2.x first,
