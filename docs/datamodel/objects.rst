...
Properties are used to attach primitive data to an object type. Prior to
EdgeDB 3.0, they must be declared with the ``property`` keyword, but the
keyword is not required in 3.0+ unless the property is a :ref:`computed
