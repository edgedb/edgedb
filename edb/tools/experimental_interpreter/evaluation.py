...
def eval_config(rt : RTConfig) -> RTVal:
    match rt.cur_expr:
        ...
        case BinProdExpr(lbl, this, next):
            ...
            return rtval_new_val(nextv, BinProdVal(lbl, Visible, thisv.val, nextv.val))
