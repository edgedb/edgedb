    ...
    match tp_comp:
        ...
        case e.NamedNominalLinkTp(name=name, linkprop=l_prop):
            ...
            return e.NamedNominalLinkTp(
                    name=name_ck,
                    linkprop=object_tp_comp_name_resolve(root_ctx=root_ctx, tp_comp=l_prop))
        ...
        case e.ComputableTp(expr=c_expr, tp=c_tp):
            return e.CompositeTp(expr=c_expr, object_tp_comp_name_resolve(root_ctx,c_tp))
...
def module_name_resolve(dbschema: e.DBSchema, module_name : Tuple[str, ...]) -> None:
    ...
    dbmodule.uncheked_defs[module_name] = e.DBModule(result_vals)
