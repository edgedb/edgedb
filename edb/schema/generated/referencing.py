    ...
    def get_internal(
        ...
        if v is not None:
            ...
            raise s_obj.FieldValueNotFoundError(
                'ReferencedObject object has no value '
                'for field `internal`'
            )
...
class ReferencedInheritingObjectMixin:
    ...
    def get_internal(
        ...
        if v is not None:
            ...
            from edb.schema import objects as s_obj
            raise s_obj.FieldValueNotFoundError(
                'ReferencedInheritingObject object has no value '
                'for field `internal`'
            )
    ...
    def get_bases(
        self, schema: 's_schema.Schema'
    ) -> 'objects.ObjectList[referencing.InheritingObject]':
...
class NamedReferencedInheritingObjectMixin:
    ...
    def get_internal(
        ...
        if v is not None:
            ...
            from edb.schema import objects as s_obj
            raise s_obj.FieldValueNotFoundError(
                'NamedReferencedInheritingObject object has no value '
                'for field `internal`'
            )
