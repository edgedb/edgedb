...
{
    CREATE ANNOTATION std::description := 'Return the current server date and \
        time.';
...
{
    CREATE ANNOTATION std::description := 'Return the date and time of the \
...
{
    CREATE ANNOTATION std::description := 'Truncate the input datetime to a \
...
{
    CREATE ANNOTATION std::description := 'Truncate the input duration to a \
        particular precision.';
...
{
    CREATE ANNOTATION std::description := 'Return duration as total number of \
        seconds in interval.';
    SET volatility := 'IMMUTABLE';
    USING SQL $$
