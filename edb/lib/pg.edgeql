...
create index match for std::cal::local_datetime using pg::brin;
create index match for std::cal::local_date using pg::brin;
create index match for std::cal::local_time using pg::brin;
create index match for std::cal::relative_duration using pg::brin;
create index match for std::cal::date_duration using pg::brin;