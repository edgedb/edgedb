...
unreserved_keywords = eql_parser.unreserved_keywords
future_reserved_keywords = eql_parser.future_reserved_keywords
reserved_keywords = (
    future_reserved_keywords | eql_parser.current_reserved_keywords
)
...
partial_reserved_keywords = eql_parser.partial_reserved_keywords
