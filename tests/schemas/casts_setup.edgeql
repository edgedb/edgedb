...
INSERT JSONTest {
    ...
    j_local_datetime := <json><local_datetime>'2018-05-07T20:01:22.306916',
    j_local_date := <json><local_date>'2018-05-07',
    j_local_time := <json><local_time>'20:01:22.306916',
    j_timedelta := <json><timedelta>'20 hrs',
    j_int16 := <json>12345,
    j_int32 := <json>1234567890,
    j_int64 := <json>1234567890123,
    j_float32 := <json>2.5,
    j_float64 := <json>2.5,
    j_decimal := <json><decimal>
        '123456789123456789123456789.123456789123456789123456789',
};
